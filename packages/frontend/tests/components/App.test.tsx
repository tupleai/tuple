...
describe('App', () => {
  it('renders the public marketing child at the root', () => {
    const { container } = render(() => (
      <App>
        <div data-testid="marketing-page">Marketing</div>
      </App>
    ));
    expect(container.querySelector('[data-testid="marketing-page"]')).not.toBeNull();
  });

  it('does not wrap the public root in AuthGuard', () => {
    const { container } = render(() => (
      <App>
        <div data-testid="marketing-page">Marketing</div>
      </App>
  ...
  it('does not render dashboard chrome at the public root', () => {
    const { container } = render(() => (
      <App>
        <div data-testid="marketing-page">Marketing</div>
      </App>
  ...
  it('does not show sidebar on the public root path', () => {
    routerState.pathname = '/';
    const { container } = render(() => (
      <App>
        <div>Marketing</div>
  ...
  it('does not show dashboard mobile navigation on the public root path', () => {
    routerState.pathname = '/';
    const { container } = render(() => (
      <App>
        <div>Marketing</div>
